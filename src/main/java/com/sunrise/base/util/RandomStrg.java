...
public class RandomStrg {
	...
	private ArrayList<Object> lower = null;

	private ArrayList<Object> upper = null;
	...
	/**
	 * get the randomly created string for use with the &lt;jsp:getProperty name=
	 * <i>"id" </i> property="randomstr"/&gt;
	 * 
	 ...
	 *          set of upper ranges
	 */
	public final void setRanges(ArrayList<Object> low, ArrayList<Object> up) {
		lower = low;
		upper = up;
	}
	...
	public final void setCharset(String value) {
		...
		// ranges
		lower = new ArrayList<Object>(3);
		upper = new ArrayList<Object>(3);
